...
public class ModResourcePackCreator implements RepositorySource {
    ...
    public static final PackSource RESOURCE_PACK_SOURCE = text -> new TranslatableComponent("pack.nameAndSource", text, new TranslatableComponent("pack.source.forgemod"));
