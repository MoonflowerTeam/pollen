 ...
 * </ul>
 *
 * <p>At the moment, Fabric only recognizes conditions for resources loaded by subclasses of {@link SimpleJsonResourceReloadListener}.
 ...
 * }
 * }</pre>
 * <p>Copied from <a href=https://github.com/FabricMC/fabric/blob/1.18/fabric-resource-conditions-api-v1/src/main/java/net/fabricmc/fabric/api/resource/conditions/v1/ResourceConditions.java>Fabric 1.18</a>
 */
public final class ResourceConditions {
    ...
    public static boolean objectMatchesConditions(JsonObject object) {
        try {
            ...
            ResourceConditionsImpl.LOGGER.warn("Skipping object " + object + ". Failed to parse resource conditions", exception);
            return false;
        }
    }
