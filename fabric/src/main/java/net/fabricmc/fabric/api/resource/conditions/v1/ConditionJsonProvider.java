 ...
 * <p>Copied from <a href=https://github.com/FabricMC/fabric/blob/1.18/fabric-resource-conditions-api-v1/src/main/java/net/fabricmc/fabric/api/resource/conditions/v1/ConditionJsonProvider.java>Fabric 1.18</a>
 */
public interface ConditionJsonProvider {
    ...
    static void write(JsonObject conditionalObject, ConditionJsonProvider @Nullable ... conditions) {
        ...
        if (conditionalObject.has(ResourceConditions.CONDITIONS_KEY))
