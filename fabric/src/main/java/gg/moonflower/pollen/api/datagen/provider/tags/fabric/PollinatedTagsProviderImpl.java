//package gg.moonflower.pollen.api.datagen.provider.tags.fabric;
//
...
//        return new PollinatedTagAppenderImpl<>(builder, registry);
//    }
//
...
//
//        protected PollinatedTagAppenderImpl(TagBuilder builder, Registry<T> registry) {
