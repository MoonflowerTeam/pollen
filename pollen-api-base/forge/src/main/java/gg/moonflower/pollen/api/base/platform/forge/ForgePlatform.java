...
public final class ForgePlatform extends Platform {
    ...
    private record ModSetupContextImpl(ParallelDispatchEvent event) implements ModSetupContext {
    ...
    private record DataSetupContextImpl(DataGenerator dataGenerator,
                                        PollinatedModContainer modContainer) implements DataSetupContext {
