package gg.moonflower.pollen.api.example.v1.geometry;
...
public class GeometryModelData {
    ...
    public static class PolyMesh {
        ...
        public PolyMesh(boolean normalizedUvs, Vector3f[] positions, Vector3f[] normals, Vec2[] uvs, Polygon[] polys, PolyType polyType) {
    ...
    public static class Polygon {
        ...
        public Polygon(int[] positions, int[] normals, int[] uvs) {
            this.positions = positions;
            this.normals = normals;
            this.uvs = uvs;
        }
