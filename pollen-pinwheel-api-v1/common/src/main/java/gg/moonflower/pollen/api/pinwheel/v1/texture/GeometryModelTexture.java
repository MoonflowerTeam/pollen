...
/**
 * A single texture used on a geometry model.
 *
 * @author Ocelot
 * @since 1.0.0
 */
public class GeometryModelTexture {
    ...
    public enum Type {
        ...
        ONLINE(location -> new ResourceLocation(PinwheelApiInitializer.MOD_ID, "base32" + ONLINE_PATTERN.matcher(new Base32().encodeAsString(location.getBytes()).toLowerCase(Locale.ROOT)).replaceAll("_")));
    ...
    public enum TextureLayer {
        ...
        SOLID, CUTOUT, CUTOUT_CULL, TRANSLUCENT, TRANSLUCENT_CULL;
    ...
    public static class Builder {
        ...
        public Builder(GeometryModelTexture texture) {
