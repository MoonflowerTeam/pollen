...
import gg.moonflower.pollen.api.pinwheel.v1.JSONTupleParser;
 ...
 * @since 1.0.0
 */
public record AnimationData(String name, AnimationData.Loop loop, MolangExpression blendWeight, float animationLength,
                            boolean overridePreviousAnimation, AnimationData.BoneAnimation[] boneAnimations,
                            AnimationData.SoundEffect[] soundEffects, AnimationData.ParticleEffect[] particleEffects,
                            AnimationData.TimelineEffect[] timelineEffects) {
    /**
