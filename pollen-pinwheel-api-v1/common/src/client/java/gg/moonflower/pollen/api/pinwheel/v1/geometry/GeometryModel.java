...
import gg.moonflower.pollen.impl.pinwheel.geometry.BedrockGeometryModel;
import gg.moonflower.pollen.impl.pinwheel.geometry.JavaModelConverter;
import gg.moonflower.pollen.mixin.AgeableListModelAccessor;
...
/**
 * An abstract part for geometry models that can be queried by {@link GeometryModelManager}.
 *
 * @author Ocelot
 * @since 1.0.0
 */
public interface GeometryModel {
    ...
    static GeometryModel create(GeometryModelData data) {
        return new BedrockGeometryModel(data.description().textureWidth(), data.description().textureHeight(), data.bones());
    }
