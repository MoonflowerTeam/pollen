...
public interface BlockRenderer {
     ...
     */
    @ApiStatus.OverrideOnly
    void render(LevelReader level, BlockPos pos, DataContainer container, MultiBufferSource buffer, PoseStack matrixStack, Camera camera, GameRenderer gameRenderer, LightTexture lightmap, int packedLight, int packedOverlay, float partialTicks);
