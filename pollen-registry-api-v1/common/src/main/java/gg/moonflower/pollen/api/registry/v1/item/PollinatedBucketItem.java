...
import gg.moonflower.pollen.api.fluid.v1.PollinatedFluid;
import gg.moonflower.pollen.api.registry.v1.content.DispenseItemBehaviorRegistry;
import gg.moonflower.pollen.mixin.BucketItemAccessor;
 ...
 * @since 1.0.0
 */
public class PollinatedBucketItem extends BucketItem {
    ...
    public PollinatedBucketItem(Supplier<? extends Fluid> fluid, Properties builder) {
        super(Fluids.EMPTY, builder);
        this.fluid = fluid;
        DispenseItemBehaviorRegistry.register(this, DISPENSE_BEHAVIOR);
    }

    public PollinatedBucketItem(Fluid fluid, Properties builder) {
        this(() -> fluid, builder);
    }
