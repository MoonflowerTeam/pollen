 ...
 * @since 1.6.0
 */
public class EmitterLifetimeOnceComponent implements CustomParticleEmitterComponent, CustomParticleListener {
    ...
    public CustomParticleComponentType<?> type() {
        return PollenParticleComponents.EMITTER_LIFETIME_ONCE.get();
    }
}
