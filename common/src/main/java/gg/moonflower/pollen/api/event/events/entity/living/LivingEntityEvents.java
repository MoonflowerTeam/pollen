...
public final class LivingEntityEvents {
    ...
    public interface Damage {
         ...
         */
        boolean livingDamage(LivingEntity entity, DamageSource source, MutableFloat modifiableDamage);
    }
    ...
    public interface Heal {
         ...
         */
        boolean heal(LivingEntity entity, MutableFloat modifiableRegen);
    }
}
