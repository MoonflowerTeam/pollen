...
public final class PlayerEvents {
    ...
    public static final PollinatedEvent<ExpPickup> EXP_PICKUP_EVENT = EventRegistry.createCancellable(ExpPickup.class);
    public static final PollinatedEvent<ExpChange> EXP_CHANGE_EVENT = EventRegistry.createCancellable(ExpChange.class);
    public static final PollinatedEvent<LevelChange> LEVEL_CHANGE_EVENT = EventRegistry.createCancellable(LevelChange.class);
    public static final PollinatedEvent<StartSleeping> START_SLEEPING_EVENT = EventRegistry.create(StartSleeping.class, events -> (player, pos) -> {
    ...
    public static final PollinatedEvent<StopSleeping> STOP_SLEEPING_EVENT = EventRegistry.createLoop(StopSleeping.class);
    public static final PollinatedEvent<Respawn> RESPAWN_EVENT = EventRegistry.createLoop(Respawn.class);
    public static final PollinatedEvent<ItemCrafted> ITEM_CRAFTED_EVENT = EventRegistry.createLoop(ItemCrafted.class);
    public static final PollinatedEvent<ItemSmelted> ITEM_SMELTED_EVENT = EventRegistry.createLoop(ItemSmelted.class);
