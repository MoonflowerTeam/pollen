...
public abstract class PollinatedBlockModelGenerator implements PollinatedModelGenerator {
    ...
    protected static BlockStateGenerator createDoor(Block doorBlock, ResourceLocation bottomHalfModelLocation, ResourceLocation bottomHalfRightHingeModelLocation, ResourceLocation topHalfModelLocation, ResourceLocation topHalfRightHingeModelLocation) {
        return MultiVariantGenerator.multiVariant(doorBlock).with(configureDoorHalf(configureDoorHalf(PropertyDispatch.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.DOUBLE_BLOCK_HALF, BlockStateProperties.DOOR_HINGE, BlockStateProperties.OPEN), DoubleBlockHalf.LOWER, bottomHalfModelLocation, bottomHalfRightHingeModelLocation), DoubleBlockHalf.UPPER, topHalfModelLocation, topHalfRightHingeModelLocation));
    }
