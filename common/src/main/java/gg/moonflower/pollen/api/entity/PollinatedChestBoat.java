...
public class PollinatedChestBoat extends PollinatedBoat implements HasCustomInventoryScreen, ContainerEntity {
    ...
    public PollinatedChestBoat(EntityType<? extends Boat> entityType, Level level) {
    ...
    public Item getDropItem() {
        ...
        return type != null ? PollinatedBoatItem.getBoatItem(type, true) : null;
    }
