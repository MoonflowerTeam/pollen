...
public final class PollenEntityTypes {
    ...
    public static final RegistryValue<EntityType<Boat>> CHEST_BOAT = ENTITY_TYPES.register("chest_boat", () -> EntityType.Builder.<Boat>of(PollinatedChestBoat::new, MobCategory.MISC).sized(1.375F, 0.5625F).clientTrackingRange(10).build("pollen:chest_boat"));
