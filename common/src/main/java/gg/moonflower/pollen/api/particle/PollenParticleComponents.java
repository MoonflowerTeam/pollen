...
public class PollenParticleComponents {
    ...
    public static final Supplier<CustomParticleComponentType<ParticleLifetimeEventComponent>> PARTICLE_LIFETIME_EVENTS = register("particle_lifetime_events", CustomParticleComponentType.particle(ParticleLifetimeEventComponent.Particle::new));
    public static final Supplier<CustomParticleComponentType<ParticleLifetimeEventComponent>> EMITTER_LIFETIME_EVENTS = register("emitter_lifetime_events", CustomParticleComponentType.emitter(ParticleLifetimeEventComponent.Emitter::new));
