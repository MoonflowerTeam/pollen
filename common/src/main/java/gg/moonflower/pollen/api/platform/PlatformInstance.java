...
public abstract class PlatformInstance {
    ...
    protected PlatformInstance(String modId) {
        this.modId = modId;
    }
    ...
    /**
     * Returns the mod id for the {@link PlatformInstance}.
     *
     * @return The {@link PlatformInstance} mod id.
     */
    ...
    /**
     * Loads the {@link PlatformInstance}.
