...
public class Pollen {
    ...
    public static final Supplier<RecipeSerializer<PollenBrewingRecipe>> BREWING_SERIALIZER = RECIPE_SERIALIZERS.register("brewing", PollenBrewingRecipe::createSerializer);    public static final Platform PLATFORM = Platform.builder(Pollen.MOD_ID)
