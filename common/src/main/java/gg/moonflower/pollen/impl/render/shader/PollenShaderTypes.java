...
public class PollenShaderTypes {
    ...
    public static void init() {
        ...
        ShaderRegistry.register(PARTICLE_SOLID, DefaultVertexFormat.PARTICLE);
        ShaderRegistry.register(PARTICLE_CUTOUT, DefaultVertexFormat.PARTICLE);
        ShaderRegistry.register(PARTICLE_TRANSLUCENT, DefaultVertexFormat.PARTICLE);
    }
}
