...
public final class RenderParticleEvents {
    ...
    public static final PollinatedEvent<Pre> PRE = EventRegistry.createLoop(Pre.class);
    public static final PollinatedEvent<Post> POST = EventRegistry.createLoop(Post.class);
